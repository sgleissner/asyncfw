...
#ifndef ATOMIC_DWCAS_ASM_H_
#define ATOMIC_DWCAS_ASM_H_
...
inline static void atomic_dw_load(volatile uint64_t atomic[2], uint64_t target[2]) noexcept
{
	asm volatile
	(
		"movq %%rbx, %%rax\n\t"			// rbx:rcx -> rax:rdx, rbx:rcx is unmodified
		"movq %%rcx, %%rdx\n\t"			// rax:rdx is early clobber and overwritten before cmpxchg16b
		"lock cmpxchg16b (%[ptr])"
...
#endif	// ATOMIC_DWCAS_NEEDED

#endif	// ATOMIC_DWCAS_ASM_H_
